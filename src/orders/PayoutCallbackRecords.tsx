...
import { generatePayoutCallbackData } from '../../data/systemMockData';

const PayoutCallbackRecords: React.FC = () => {
  const columns = [
  ...
  const data = generatePayoutCallbackData(10);
...
export default PayoutCallbackRecords;
